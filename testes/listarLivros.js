...
function listarLivros() { //função para listar livros no console

 for (let i = 0; i < dadosLivros.length; i++ ) { //percorrendo os livros do array
 ...
 const livro = dadosLivros[i]; //armazenando o livro atual
  ...
  console.log(`Status: ${livro.getDisponivel() ? 'Disponível' : 'Indisponível'}`)
